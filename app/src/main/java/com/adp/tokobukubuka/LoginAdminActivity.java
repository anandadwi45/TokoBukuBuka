...
public class LoginAdminActivity extends AppCompatActivity {
    ...
    private String url = Server.URL + "loginadmin.php";
...
//        btn_register = (Button) findViewById(R.id.btn_register);
        ...
        if (session) {
            Intent intent = new Intent(LoginAdminActivity.this, AdminBukuActivity.class);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        editor.putBoolean(isadmin_status, true);
