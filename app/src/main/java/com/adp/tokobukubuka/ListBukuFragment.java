...
public class ListBukuFragment extends Fragment {
    ...
    public static ArrayList<String> nama_penulis = new ArrayList<String>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_list_buku, null);
...
//        sharedpreferences = getSharedPreferences(Login.my_shared_preferences, Context.MODE_PRIVATE);
        ...
        cla = new AdapterListBukuAll(this.getActivity());
        ...
        ListBuku.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                Intent iDetail = new Intent(getActivity(), DetailBukuActivity.class);
